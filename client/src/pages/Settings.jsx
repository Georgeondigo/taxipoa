        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div
                  className={`inline-flex items-center gap-1.5 mt-1.5 px-2 py-0.5 rounded-full text-xs font-medium font-body ${
                    user?.plan === "free"
          ...
          <div className="bg-white rounded-2xl border border-red-100 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-red-50">
              <h3 className="font-display font-semibold text-red-700 text-sm">
                Danger Zone
              </h3>
            </div>
          ...
          >
            <div className="bg-amber-50 border border-amber-100 rounded-xl p-3 flex gap-2">
              ...
              <p className="text-amber-700 text-xs font-body">
                Use a strong password with at least 8 characters. Never share
        ...
        <div className="space-y-4">
          ...
          >
            <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
              <p className="text-blue-700 text-sm font-body">
                <span className="font-semibold">SMS reminders</span> are sent
                automatically to your registered phone number 30 days, 7 days,
                and 1 day before June 30 — giving you time to prepare your
                TaxiPoa summary before filing on iTax.
              </p>
            </div>
            {/* Test SMS button */}
            <div className="pt-2 border-t border-slate-100">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="font-body text-xs text-slate-400 mt-0.5">
                    Send yourself a sample reminder right now
                  </p>
                </div>
                <button
                  onClick={async () => {
                    try {
                      await api.post("/api/reminders/test");
                      toast.success("Test SMS sent! Check your phone.");
                    } catch (err) {
                      toast.error(err.response?.data?.message || "SMS failed");
                    }
                  }}
                  className="px-4 py-2 bg-[#1A5276] text-white font-display font-semibold text-xs rounded-xl hover:bg-[#154360] transition-all duration-200 cursor-pointer"
                >
                  Send Test
                </button>
              </div>
            ...
            {[
              {
                ...
                desc: "May 31 — early warning to start filing",
                enabled: true,
              },
              {
                label: "7 days before deadline",
                desc: "June 23 — urgent reminder to complete filing",
                enabled: true,
              },
              {
                label: "1 day before deadline",
                desc: "June 29 — final reminder",
                enabled: true,
              },
              ...
              <div className="bg-orange-50 border border-orange-100 rounded-xl p-4 flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-orange-700 text-xs font-body mt-0.5">
                    Add your phone number in the Profile tab to receive SMS
                    reminders.
                  </p>
                  <button
          ...
          >
            {[
              {
                date: "20th monthly",
                obligation: "Turnover Tax (TOT) return",
                urgent: false,
              },
              {
                date: "30 June annually",
                obligation: "Individual Income Tax return",
                urgent: true,
              },
              {
                date: "20 Apr, Jul, Oct",
                obligation: "Instalment tax payments",
                urgent: false,
              },
              {
                date: "20th monthly",
                obligation: "VAT return (if registered)",
                urgent: false,
              },
              ...
              >
                ...
                <span
                  className={`text-xs font-medium font-body px-2 py-0.5 rounded-full ${
                    urgent
