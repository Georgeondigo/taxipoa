...
function generateTaxSummaryPDF(filing, calculationResult, user) {
 ...
 doc.fillColor(WHITE)
   .font('Helvetica-Bold')
   .fontSize(13)
   .text('iTAX REFERENCE SUMMARY', 60, 22, { align: 'right' });
  ...
  doc.fillColor(PRIMARY)
   .font('Helvetica-Bold')
   .fontSize(11)
   .text('HOW TO FILE ON iTAX USING THIS SUMMARY', 60, calcY);
  ...
  '3. Use the figures in this summary to fill in each field on iTax',
  '4. Submit your return and note your Payment Registration Number (PRN)',
  '5. Pay via M-Pesa: Paybill 222222, Account = your PRN',
  ...
  doc.fillColor('#7F8C8D')
     ...
     .fontSize(8)
     .text(
       'This document is generated by TaxiPoa to help you understand your tax position and for reference purposes only. ' +
