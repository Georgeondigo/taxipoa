...
import { CheckCircle, ArrowRight, ArrowLeft, FileText, Briefcase, Home, ShoppingBag, CircleCheck } from 'lucide-react'
    ...
    <div className="flex items-center justify-center mb-8">
      {steps.map((step, index) => (
        <div key={step} className="flex items-center">
          <div className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-display font-semibold transition-all duration-300 ${
            index < currentStep
          ...
          {index < steps.length - 1 && (
            <div className={`w-12 h-px mx-3 transition-all duration-300 ${
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <h2 className="font-display text-2xl font-bold text-slate-800">New Tax Filing</h2>
        <p className="text-slate-500 text-sm font-body mt-1">
          Let's set up your KRA tax return — takes less than 2 minutes
        </p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 sm:p-8">
        ...
        {step === 0 && (
          <div>
            ...
            <p className="text-slate-500 text-sm font-body mb-6">
              KRA tax years run from January 1 to December 31.
                ...
                >
                  <div className="text-left">
                    <div className={`font-display font-semibold ${
                      selectedYear === year ? 'text-[#1A5276]' : 'text-slate-800'
                    }`}>
                      Tax Year {year}
                    </div>
        ...
        {step === 1 && (
          <div>
            ...
            <p className="text-slate-500 text-sm font-body mb-6">
              Select all that apply — you can add the actual amounts in the next step.
            </p>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-slate-500 text-xs font-body mt-0.5">{desc}</div>
                    </div>
        ...
        {step === 2 && (
          <div>
            ...
            <p className="text-slate-500 text-sm font-body mb-2">
              Don't worry — TaxiPoa will calculate both and recommend the cheaper option after you enter your numbers.
            </p>

            <div className="bg-blue-50 border border-blue-100 rounded-xl p-3 mb-6">
              <p className="text-blue-700 text-xs font-body">
                <span className="font-semibold">Not sure?</span> Pick Income Tax.
                It works for everyone and TaxiPoa will tell you if TOT would save you money.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Progressive rates 10%–35% on taxable income after deductions. Best for most freelancers.',
                  tag: 'Recommended',
                ...
                },
                {
                  ...
                  desc: '1.5% flat rate on gross turnover. Simple but no expense deductions allowed.',
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        ...
                        <div className="text-slate-500 text-xs font-body mt-1">{desc}</div>
                      </div>
                      <div className="flex items-center gap-2 flex-shrink-0 ml-4">
                        <span className={`text-xs font-medium px-2 py-0.5 rounded-full font-body ${tagColor}`}>
                          {tag}
                        </span>
                        <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${
                          selected ? 'border-[#1A5276] bg-[#1A5276]' : 'border-slate-300'
                        }`}>
                    ...
                    <ul className="space-y-1">
                      {details.map((d) => (
                        <li key={d} className="flex items-start gap-2 text-xs text-slate-500 font-body">
            ...
            <div className="mt-6 bg-slate-50 rounded-xl p-4 border border-slate-100">
              <p className="text-slate-600 text-sm font-body font-medium mb-2">Your filing summary:</p>
              <div className="space-y-1">
                <div className="flex justify-between text-sm">
                  <span className="text-slate-500 font-body">Tax year</span>
                  <span className="font-display font-semibold text-slate-800">{selectedYear}</span>
                </div>
                <div className="flex justify-between text-sm">
        ...
        <div className="flex items-center justify-between mt-8 pt-6 border-t border-slate-100">
          <button
            onClick={() => step === 0 ? navigate('/filings') : setStep(s => s - 1)}
